    ...
    public void run() {
        ...
        while (!end.get()) {
            try {
                ...
                // FIX: Added detailed error logging. This will print the exact error
                // that is causing the thread to crash.
                System.err.println("CRITICAL ERROR in connection thread, terminating connection. See stack trace below:");
                e.printStackTrace();
                break;
            }
        }
