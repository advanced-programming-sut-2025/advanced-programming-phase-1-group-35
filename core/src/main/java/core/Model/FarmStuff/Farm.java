...
import core.Model.enums.FarmType;
...
public class Farm {
    ...
    private ArrayList<core.Model.CropClasses.Crop> Crop = new ArrayList<>();
...
//    }
    ...
    public ArrayList<core.Model.CropClasses.Crop> getCrop() {
        return Crop;
    }

    public void setCrop(ArrayList<core.Model.CropClasses.Crop> crop) {
        Crop = crop;
    }
