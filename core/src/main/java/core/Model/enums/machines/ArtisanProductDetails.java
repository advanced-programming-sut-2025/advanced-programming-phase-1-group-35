...
import static core.Model.enums.Crops.CropEnum.*;
import static core.Model.enums.Crops.SeedEnum.SUNFLOWERSEED;
import static core.Model.enums.animal.AnimalProductDetails.*;
public enum ArtisanProductDetails implements ItemInterface, ItemConstant {
    ...
    goat_Cheese("Soft cheese made from goat's milk.", 100, 3, new HashMap<>() {{put(new ItemInterface[]{GoatMilk},1);}}, 400,"craftingItems/goatcheese"),
    ...
    Pale_Ale("Drink in moderation.", 50, 3*24, new HashMap<>() {{put(new ItemInterface[]{HOPS},1);}}, 300,"craftingItems/paleale"),
    Wine("Drink in moderation.", -1, 7*24, new HashMap<>() {{put(Fruit.values(),1);}}, -1,"craftingItems/wine"),
    Dried_Mushroom("A package of gourmet mushrooms.", 50, -1, new HashMap<>() {{put(new ItemInterface[]{COMMON_MUSHROOM},5);put(new ItemInterface[]{RED_MUSHROOM},5);put(new ItemInterface[]{PURPLE_MUSHROOM},5);}}, -1,"craftingItems/driedmushroom"),
    Dried_Fruit("Chewy pieces of dried fruit.", 75, -1, new HashMap<>() {{put(Fruit.values(),5);}}, -1,"craftingItems/driedfruit"), //TODO:x*7.5 +25
    ...
    Duck_Mayonnaise("It's a rich, yellow mayonnaise.", 75, 3, new HashMap<>() {{put(new ItemInterface[]{DuckEgg},1);}}, 375,"craftingItems/duckmayonnaise"),
    Dinosaur_Mayonnaise("It's thick and creamy, with a vivid green hue.\nIt smells like grass and leather.", 125, 3, new HashMap<>() {{put(new ItemInterface[]{DinoEgg},1);}}, 800,"craftingItems/dinomayonnaise"),
    Truffle_Oil("A gourmet cooking ingredient.", 38, 6, new HashMap<>() {{put(new ItemInterface[]{Truffle},1);}}, 1065,"craftingItems/truffleoil"),
    Corn_Oil("All purpose cooking oil.", 13, 6, new HashMap<>() {{put(new ItemInterface[]{CORN},1);}}, 100,"craftingItems/cornoil"),
    SunFlower_Oil("All purpose cooking oil.", 13, 1, new HashMap<>() {{put(new ItemInterface[]{SUNFLOWER},1);}}, 100,"craftingItems/sunfloweroil"),
    ...
    Smoked_Fish("A whole fish, smoked to perfection.", -1, 1, new HashMap<>() {{put(FishType.values(),1);}}, -1,"craftingItems/smokedfish"),
    Copper_Bar("Turns ore and coal into metal bars.", -1, 4, new HashMap<>() {{put(FishType.values(),1);}}, -1,"craftingItems/anymetalbar"),    // TODO:it needs coal too
