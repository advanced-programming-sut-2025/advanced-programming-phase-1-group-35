...
public enum ArtisanProductDetails {
    ...
    Juice("A sweet, nutritious beverage.", -1, 4*24, new HashMap<>() {{put(new ItemInterface[]{});}}, -1),  // computed from ingredient
    Mead("A fermented beverage made from honey.", 100, 10, null, 300),
    PaleAle("Drink in moderation.", 50, 3*24, null, 300),
    Wine("Drink in moderation.", -1, 7*24, null, -1),  // computed from fruit
    DriedMushroom("A package of gourmet mushrooms.", 50, -1, null, -1),  // computed
    DriedFruit("Chewy pieces of dried fruit.", 75, -1, null, -1),        // computed
    Raisins("It's said to be the Junimos' favorite food.", 125, -1, null, 600),

    // Additional items
    Cloth("A bolt of fine wool cloth.", -1, 4, null, 470),
    Mayonnaise("It looks spreadable.", 50, 3, null, 190), // handle Large Egg logic
    DuckMayonnaise("It's a rich, yellow mayonnaise.", 75, 3, null, 375),
    DinosaurMayonnaise("It's thick and creamy, with a vivid green hue.\nIt smells like grass and leather.", 125, 3, null, 800),
    TruffleOil("A gourmet cooking ingredient.", 38, 6, null, 1065),
    CornOil("All purpose cooking oil.", 13, 6, null, 100),
    SunFlowerOil("All purpose cooking oil.", 13, 1, null, 100),
    SunFlowerSeedsOil("All purpose cooking oil.", 13, 48, null, 100),
    Pickles("A jar of your home-made pickles.", -1, 6, null, -1), // computed
    Jelly("Gooey.", -1, 3*24, null, -1),  // computed
    SmokedFish("A whole fish, smoked to perfection.", -1, 1, null, -1), // computed
    AnyMetalBar("Turns ore and coal into metal bars.", -1, 4, null, -1), // computed
    Coal("Turns 10 pieces of wood into one piece of coal.", -1, 1, null, 50);
