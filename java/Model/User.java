...
public class User {
    ...
    private ArrayList<models.TradeAndGift.Gift> Gifts;
    ...
    public Result RateGift(models.TradeAndGift.Gift gift){
    ...
    public Result respondToTrade(models.TradeAndGift.Trade trade){
