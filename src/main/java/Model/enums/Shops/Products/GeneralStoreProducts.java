...
public enum GeneralStoreProducts implements ShopProduct, ItemConstant ,ItemInterface{
    ...
    //Soils
    SPEED_GRO("Item","Speed_Gro", "Makes the plants grow 1 day earlier.", 100, Double.POSITIVE_INFINITY, null),
    DELUXE_RETAINING_SOIL("Item","Deluxe_Retaining_Soil", "This soil has a 100% chance of staying watered overnight. Mix into tilled soil.", 150, Double.POSITIVE_INFINITY, null),
    BASIC_RETAINING_SOIL("Item", "Basic_Retaining_Soil", "This soil has a chance of staying watered overnight. Mix into tilled soil.", 100, Double.POSITIVE_INFINITY, null),
    QUALITY_RETAINING_SOIL("Item", "Quality_Retaining_Soil", "This soil has a good chance of staying watered overnight. Mix into tilled soil.", 150, Double.POSITIVE_INFINITY, null),
    //BackPacks
    LARGE_PACK("BackPack", "Large_Pack", "Unlocks the 2nd row of inventory (12 more slots, total 24).", 2000, 1.0, null),
    DELUXE_PACK("BackPack", "Deluxe_Pack", "Unlocks the 3rd row of inventory (infinite slots).", 10000, 1.0, null),
    // Spring Stock
    PARSNIP("Seed","Parsnip_Seeds", "Plant these in the spring. Takes 4 days to mature.", 25, 5.0, Seasons.Spring),
    BEAN("Seed","Bean_Starter", "Plant these in the spring. Takes 10 days to mature, but keeps producing after that. Grows on a trellis.", 75, 5.0 , Seasons.Spring),
    CAULIFLOWER("Seed","Cauliflower_Seeds", "Plant these in the spring. Takes 12 days to produce a large cauliflower.", 100, 5.0, Seasons.Spring),
    POTATO("Seed","Potato_Seeds", "Plant these in the spring. Takes 6 days to mature, and has a chance of yielding multiple potatoes at harvest.", 62, 5.0, Seasons.Spring),
    STRAWBERRY("Seed","Strawberry_Seeds", "Plant these in spring. Takes 8 days to mature, and keeps producing strawberries after that.", 100, 5.0, Seasons.Spring),
    TULIP("Seed","Tulip_Bulb", "Plant in spring. Takes 6 days to produce a colorful flower. Assorted colors.", 25, 5.0, Seasons.Spring),
    KALE("Seed","Kale_Seeds", "Plant these in the spring. Takes 6 days to mature. Harvest with the scythe.", 87, 5.0, Seasons.Spring),
    COFFEE("Seed","Coffee_Beans", "Plant in summer or spring. Takes 10 days to grow, Then produces coffee Beans every other day.", 200, 1.0, Seasons.Spring),
    CARROT("Seed","Carrot_Seeds", "Plant in the spring. Takes 3 days to grow.", 5, 10.0, Seasons.Spring),
    RHUBARB("Seed","Rhubarb_Seeds", "Plant these in the spring. Takes 13 days to mature.", 100, 5.0, Seasons.Spring),
    JAZZ("Seed","Jazz_Seeds", "Plant in spring. Takes 7 days to produce a blue puffball flower.", 37, 5.0, Seasons.Spring),
    // Summer Stock
    TOMATO("Seed", "Tomato_Seeds", "Plant these in the summer. Takes 11 days to mature, and continues to produce after first harvest.", 62, 5.0, Seasons.Summer),
    PEPPER("Seed","Pepper_Seeds", "Plant these in the summer. Takes 5 days to mature, and continues to produce after first harvest.", 50, 5.0, Seasons.Summer),
    WHEAT("Seed","Wheat_Seeds", "Plant these in the summer or fall. Takes 4 days to mature. Harvest with the scythe.", 12, 10.0, Seasons.Summer),
    SUMMER_SQUASH("Seed","Summer_Squash_Seeds", "Plant in the summer. Takes 6 days to grow, and continues to produce after first harvest.", 10, 10.0, Seasons.Summer),
