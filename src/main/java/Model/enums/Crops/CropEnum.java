    ...
    public enum CropEnum implements ItemInterface,ItemConstant {
        ...
        COMMON_MUSHROOM("Common Mushroom", SeedEnum.MIXED, List.of(1), 0, true, 0, 40, true, 38, List.of(Seasons.Winter, Spring, Summer, Fall), false, true),
        ...
        SPRING_ONION("Spring Onion", SeedEnum.MIXED, List.of(1), 0, true, 0, 8, true, 13, List.of(Spring), false, true),
        WILD_HORSERADISH("Wild Horseradish", SeedEnum.MIXED, List.of(1), 0, true, 0, 50, true, 13, List.of(Spring), false, true),
        FIDDLEHEAD_FERN("Fiddlehead Fern", SeedEnum.MIXED, List.of(1), 0, true, 0, 90, true, 25, List.of(Summer), false, true),
        RED_MUSHROOM("Red Mushroom", SeedEnum.MIXED, List.of(1), 0, true, 0, 75, true, -50, List.of(Summer), false, true),
        SPICE_BERRY("Spice Berry", SeedEnum.MIXED, List.of(1), 0, true, 0, 80, true, 25, List.of(Summer), false, true),
        SWEET_PEA("Sweet Pea", SeedEnum.MIXED, List.of(1), 0, true, 0, 50, true, 0, List.of(Summer), false, true),
        ...
        PURPLE_MUSHROOM("Purple Mushroom", SeedEnum.MIXED, List.of(1), 0, true, 0, 90, true, 30, List.of(Fall), false, true),
        WILD_PLUM("Wild Plum", SeedEnum.MIXED, List.of(1), 0, true, 0, 80, true, 25, List.of(Fall), false, true),
        CROCUS("Crocus", SeedEnum.MIXED, List.of(1), 0, true, 0, 60, true, 0, List.of(Winter), false, true),
        CRYSTAL_FRUIT("Crystal Fruit", SeedEnum.MIXED, List.of(1), 0, true, 0, 150, true, 63, List.of(Winter), false, true),
        HOLLY("Holly", SeedEnum.MIXED, List.of(1), 0, true, 0, 80, true, -37, List.of(Winter), false, true),
        SNOW_YAM("Snow Yam", SeedEnum.MIXED, List.of(1), 0, true, 0, 100, true, 30, List.of(Winter), false, true),
        WINTER_ROOT("Winter Root", SeedEnum.MIXED, List.of(1), 0, true, 0, 70, true, 25, List.of(Winter), false, true)
