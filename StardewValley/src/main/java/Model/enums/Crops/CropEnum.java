    ...
    public enum CropEnum implements ItemInterface,ItemConstant {
        ...
        COMMON_MUSHROOM("Common Mushroom", null, List.of(1), 0, true, 0, 40, true, 38, List.of(Seasons.Winter, Spring, Summer, Fall), false, true),
        DAFFODIL("Daffodil", null, List.of(1), 0, true, 0, 30, true, 0, List.of(Spring), false, true),
        DANDELION("Dandelion", null, List.of(1), 0, true, 0, 40, true, 25, List.of(Spring), false, true),
        LEEK("Leek", null, List.of(1), 0, true, 0, 60, true, 40, List.of(Spring), false, true),
        MOREL("Morel", null, List.of(1), 0, true, 0, 150, true, 20, List.of(Spring), false, true),
        SALMONBERRY("Salmonberry", null, List.of(1), 0, true, 0, 5, true, 25, List.of(Spring), false, true),
        SPRING_ONION("Spring Onion", null, List.of(1), 0, true, 0, 8, true, 13, List.of(Spring), false, true),
        WILD_HORSERADISH("Wild Horseradish", null, List.of(1), 0, true, 0, 50, true, 13, List.of(Spring), false, true),
        FIDDLEHEAD_FERN("Fiddlehead Fern", null, List.of(1), 0, true, 0, 90, true, 25, List.of(Summer), false, true),
        RED_MUSHROOM("Red Mushroom", null, List.of(1), 0, true, 0, 75, true, -50, List.of(Summer), false, true),
        SPICE_BERRY("Spice Berry", null, List.of(1), 0, true, 0, 80, true, 25, List.of(Summer), false, true),
        SWEET_PEA("Sweet Pea", null, List.of(1), 0, true, 0, 50, true, 0, List.of(Summer), false, true),
        BLACKBERRY("Blackberry", null, List.of(1), 0, true, 0, 25, true, 25, List.of(Fall), false, true),
        CHANTERELLE("Chanterelle", null, List.of(1), 0, true, 0, 160, true, 75, List.of(Fall), false, true),
        HAZELNUT("Hazelnut", null, List.of(1), 0, true, 0, 40, true, 38, List.of(Fall), false, true),
        PURPLE_MUSHROOM("Purple Mushroom", null, List.of(1), 0, true, 0, 90, true, 30, List.of(Fall), false, true),
        WILD_PLUM("Wild Plum", null, List.of(1), 0, true, 0, 80, true, 25, List.of(Fall), false, true),
        CROCUS("Crocus", null, List.of(1), 0, true, 0, 60, true, 0, List.of(Winter), false, true),
        CRYSTAL_FRUIT("Crystal Fruit", null, List.of(1), 0, true, 0, 150, true, 63, List.of(Winter), false, true),
        HOLLY("Holly", null, List.of(1), 0, true, 0, 80, true, -37, List.of(Winter), false, true),
        SNOW_YAM("Snow Yam", null, List.of(1), 0, true, 0, 100, true, 30, List.of(Winter), false, true),
        WINTER_ROOT("Winter Root", null, List.of(1), 0, true, 0, 70, true, 25, List.of(Winter), false, true)
